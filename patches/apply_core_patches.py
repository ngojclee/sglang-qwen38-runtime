...
# 2. Patch qwen3_5.py get_layer prefix
...
if target2 in code2:
    ...
    with open(qwen35_path, "w", encoding="utf-8") as f:
        f.write(code2)
    print("Patched qwen3_5.py successfully!")
else:
    print("qwen3_5.py target2 not exact, checking regex...")
    ...
    with open(qwen35_path, "w", encoding="utf-8") as f:
        f.write(code2)
    print("Patched qwen3_5.py via regex!")
